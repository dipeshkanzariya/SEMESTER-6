...
namespace TeaPost.DAL.Shop
{
    public class Shop_DALBase : DAL_Helper
    {
        ...
        public DataTable dbo_PR_INSERT_SHOP(string ShopName, string ShopImage, string ShopArea, string SeatingCapacity, string VentilationType, string BrewedTea)
        {
            try
            {
                SqlDatabase sqlDb = new SqlDatabase(MyConnectionString);
        ...
        public DataTable dbo_PR_UPDATE_SHOP(int ShopID, string ShopName, string ShopImage, string ShopArea, string SeatingCapacity, string VentilationType, string BrewedTea)
        {
            try
            {
                SqlDatabase sqlDb = new SqlDatabase(MyConnectionString);
