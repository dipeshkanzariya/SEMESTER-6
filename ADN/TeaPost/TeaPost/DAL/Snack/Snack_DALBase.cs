...
namespace TeaPost.DAL.Snack
{
    public class Snack_DALBase : DAL_Helper
    {
        ...
        public DataTable dbo_PR_PR_INSERT_SNACK(string Snackname, string SnackImage, decimal Price, string BriefDescription, int Size, string Description, int ShopID)
        {
            try
            {
                SqlDatabase sqlDb = new SqlDatabase(MyConnectionString);
                ...
                sqlDb.AddInParameter(cmd, "@Size", SqlDbType.Int, Size);
        ...
        public DataTable dbo_PR_UPDATE_SNACK(int SnackID, string Snackname, string SnackImage, decimal Price, string BriefDescription, int Size, string Description, int ShopID)
        {
            try
            {
                SqlDatabase sqlDb = new SqlDatabase(MyConnectionString);
