...
namespace TeaPost.DAL.Tea
{
    public class Tea_DALBase : DAL_Helper
    {
        ...
        public DataTable dbo_PR_INSERT_TEA(string TeaName, string TeaImage, decimal Price, string BriefDescription, decimal Weight, int Stock, string Description, int ShopID)
        {
            try
            {
                SqlDatabase sqlDb = new SqlDatabase(MyConnectionString);
                ...
                sqlDb.AddInParameter(cmd, "@Weight", SqlDbType.Decimal, Weight);
                sqlDb.AddInParameter(cmd, "@Stock", SqlDbType.Int, Stock);
        ...
        public DataTable dbo_PR_UPDATE_TEA(int TeaID, string TeaName, string TeaImage, decimal Price, string BriefDescription, decimal Weight, int Stock, string Description, int ShopID)
        {
            try
            {
                SqlDatabase sqlDb = new SqlDatabase(MyConnectionString);
