...
namespace TeaPost.Areas.Shop.Controllers
{
    ...
    public class ShopController : Controller
    {
        ...
        public IActionResult ShopAddEdit(int ShopID) 
        {
            if(ShopID != null && ShopID > 0)
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    model.ShopDescription = dr["ShopDescription"].ToString();
                }
                return View(model);
            }
            return View();
        ...
        public IActionResult ShopSave(ShopModel model)
        {
            ...
            {
                DataTable dt = dalShop.dbo_PR_UPDATE_SHOP(model.ShopID, model.ShopName, model.ShopImage, model.ShopArea, model.SeatingCapacity, model.VentilationType, model.ShopDescription, model.BrewedTea);
